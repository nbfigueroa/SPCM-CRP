...
The dataset is generated by two distinct Covariance matrices and which are randomly transformed (rotation, scale, noise). The similar matrices are depicted by the colors of their ellipsoids.
