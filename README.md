...
**NOTE:** If you are interested in the application of these methods to time-series segmentation and action discovery introduced in [1] you must go to [https://github.com/nbfigueroa/ICSC-HMM.git](https://github.com/nbfigueroa/ICSC-HMM.git)
...
#### Reference
[1] [Nadia Figueroa](http://lasa.epfl.ch/people/member.php?SCIPER=238387) and Aude Billard, "Geometric Transform Invariant Non-Parametric Clustering of Covariance Matrices and its Application to Unsupervised Joint Segmentation and Action Discovery." *Journal of Machine Learning Research* [Under Review](https://arxiv.org/abs/1710.10060). 
...
To run your own experiments on the Diffusion Tensor Image Dataset you must download:
...
The dataset is generated by **two distinct SPD/covariance matrices** which are randomly transformed (rotation, scale, noise). The similar matrices are depicted by the colors of their ellipsoids.
