function TensorODF=DEMO_tensor2tensorODF_faster()
%-fanDTasia ToolBox------------------------------------------------------------------
...
%
%-USE--------------------------------------------------------------------------------
% TensorODF=DEMO_tensor2tensorODF_faster;
%
...
UnitVectors;
GradientOrientations=g([1:21],:); %Define a set of new Gradient Orientations
