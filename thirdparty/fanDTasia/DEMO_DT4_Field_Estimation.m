function TensorCoefficients=DEMO_DT4_Field_Estimation()
%-fanDTasia ToolBox------------------------------------------------------------------
...
%
%-DESCRIPTION------------------------------------------------------------------------
% This demo script shows how to compute a field of High-Order Diffusion Tensors from a
% given Diffusion-Weighted MRI dataset. The method guarantees that the estimated tensors
...
%
%-USE--------------------------------------------------------------------------------
% D=DEMO_DT4_Field_Estimation;
%
% D: is the computed 2D field of higher-order tensors in the form of a NxSizeXxSizeY matrix
%
%-DISCLAIMER-------------------------------------------------------------------------
