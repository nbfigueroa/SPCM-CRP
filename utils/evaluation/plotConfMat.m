function [handle] = plotConfMat(varargin)
...
% plotting the colors
imagesc(confpercent);
title(sprintf('Accuracy: %.2f%%', 100*trace(confmat)/sum(confmat(:))),'Interpreter','Tex');
ylabel('True Labels','Interpreter','LaTex'); xlabel('Cluster Labels','Interpreter','LaTex');
